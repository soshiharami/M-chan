...
export class Bot {
	...
	constructor(
		...
		private reactionDeleteHandler: ReactionDeleteHandler,
	...
	private registerListeners(): void {
		...
		this.client.on(
			...
			(messageReaction: MessageReaction | PartialMessageReaction, user: User | PartialUser) =>
				this.onReactionDelete(messageReaction, user)
		);
	...
	private async onReactionDelete(
		...
		try {
			await this.reactionDeleteHandler.process(
				msgReaction,
